...
export async function GET(req, { params }) {
    try {
        ...
        const estoque = await service.buscarPorId(id);
...
export async function PUT(req, { params }) {
    try {
        ...
        const res = await service.atualizar(id, body.produtoVariacaoId, body.quantidade, body.quantidade_reservada, body.estoque_minimo);
