...
export async function GET(req, { params }) {
    try {
        ...
        const lojista = await service.buscarPorId(id);
        return NextResponse.json(lojista, { status: 200 });
    } catch (e) {
...
export async function PUT(req, { params }) {
    try {
        ...
        const res = await service.atualizar(id, body.cargo, body.usuarioId, body.lojaId);
