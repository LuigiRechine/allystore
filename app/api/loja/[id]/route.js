...
export async function GET(req, { params }) {
    try {
        ...
        const loja = await service.buscarPorId(id);
...
export async function PUT(req, { params }) {
    try {
        ...
        const res = await service.atualizar(id, body.nome, body.slug, body.email, body.status, body.logo, body.descricao, body.telefone);
